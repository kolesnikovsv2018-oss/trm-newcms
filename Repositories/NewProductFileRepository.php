 ...
 */
static protected array $ParentRelationIdFieldName = array( "new_products_files", "ID_Product" );
...
public function __construct(TRMDataSourceInterface $DataSource) 
{
    ...
    $this->getParentedDataMapper()->setParentIdFieldName(array( "new_products_files", "ID_Product" ));
