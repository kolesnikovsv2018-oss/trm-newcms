...
TRMLib::ap($arr5);
    ...
    $TestCollection = new NewComplectPartRepository($this->DIC->get(TRMSqlDataSource::class));

    TRMLib::ip( $TestCollection->getBy("complect", "ID_Complect", 13354) );
...
{
//    $vue_source = file_get_contents(ROOT . '/trm/newcms/js/chunk-vendors.71471957.js');
//    $app_source = file_get_contents(ROOT . '/trm/newcms/js/app.8781b8d6.js');
