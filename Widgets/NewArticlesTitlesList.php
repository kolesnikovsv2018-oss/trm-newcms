 ...
 * @param bool $AllArticles - true = выводит все подряд, false = только статьи для этого сайта и сателитов (сейчас не используется)
 * 
 * @return bool
 */
static function printArticlesTitles(NewArticleRepository $ArticlesRep, int $ArticlesType, int $num = 0, int $id_before = 0, bool $AllArticles = false): bool
{
