...
/**
 * 
 * @param NewLiteProductForCollectionRepository $Rep - репозиторий товаров для коллекции
 */
 ...
 * 
 * @return TRMDataObjectsCollectionInterface|null
 */
 ...
 * 
 * @param int|string $ID_price - ID-товара
 ...
 */
public function setLastProducts($ID_price, int $GoodsCount = 3): void
{
    if(!$ID_price)
    {
 ...
 * @return void
 */
public static function generateCookiesName(): void
{
 ...
 * @return void
 */
static public function render(NewLastProducts $LastProductsObject): void
{
