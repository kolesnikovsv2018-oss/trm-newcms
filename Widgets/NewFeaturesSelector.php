...
class NewFeaturesSelector
{
   ...
   */
  public function getPageNumericName(): string
  {
   ...
   * @return void
   */
  public function setPageNumericName(string $PageNumericName): void
  {
   ...
   * @return void
   */
  public function setCurrentGroupId(int $GroupId, string $GroupURL): void
  {
  ...
  /**
   * @return int|null - ID-группы товаров
   */
   ...
   */
  public function getCurrentGroupURL(): string
  {
  ...
  /**
   * @return array - массив с ID-номерами товаров, входящих в основную группу и ее дочерние
   */
  public function generateProductsId(): array
  {
